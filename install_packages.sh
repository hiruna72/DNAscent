...
boost_installation () {
    ...
    rm boost_1_86_0.tar.gz || die "failed"
}
...
zlib_installation () {
    ...
    mv zlib-1.2.13 zlib || die "failed"
}
...
cuda_installation () {
    ...
    rm cuda_11.0.2_450.51.05_linux.run || die "failed"
}
...
info "cudnn-11.0-linux-x64-v8.0.2.39"
    ...
    mv cuda cudnn-v8.0-cuda-11.0 || die "failed"
}
